...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'subtle': '0 1px 2px 0 rgba(41, 38, 49, 0.03)',
        'card': '0 1px 3px 0 rgba(41, 38, 49, 0.04), 0 1px 2px -1px rgba(41, 38, 49, 0.02)',
        'card-hover': '0 6px 16px -2px rgba(41, 38, 49, 0.06), 0 2px 4px -1px rgba(41, 38, 49, 0.03)',
      },
      animation: {
